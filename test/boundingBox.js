...
test('`boundingBox` should return correct coordinates from shape', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`boundingBox` should return correct coordinates from shape array', () => {
  const shapes = [
    [
      { x: 0, y: 0, moveTo: true },
      { x: 100, y: 0 },
...
test('`boundingBox` should return correct coordinates from circle', () => {
  const shape = [
