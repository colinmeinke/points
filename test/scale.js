...
test('`scale` should increase scale correctly from center', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should decrease scale correctly from center', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should increase scale correctly from top left', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should decrease scale correctly from top left', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should increase scale correctly from top right', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should decrease scale correctly from top right', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should increase scale correctly from bottom right', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should decrease scale correctly from bottom right', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should increase scale correctly from bottom left', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should decrease scale correctly from bottom left', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`scale` should increase scale correctly when shape array', () => {
  const shapes = [
    [
      { x: 0, y: 0, moveTo: true },
      { x: 100, y: 0 },
