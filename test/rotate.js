...
test('`rotate` should correctly calculate rotation of square', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`rotate` should correctly calculate rotation of triangle', () => {
  const shape = [
...
test('`rotate` should correctly calculate rotation of curved path', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
