...
test('`length` should calculate correct length of square', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 100 },
...
test('`length` should calculate correct length of reversed square', () => {
  const shape = [
...
test('`length` should calculate correct length of rectangle', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 50 },
...
test('`length` should calculate correct length of right angle triangle', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
    { x: 100, y: 50 },
...
test('`length` should calculate correct length of non right angle triangle', () => {
  const shape = [
    { x: 100, y: 100, moveTo: true },
    { x: 127, y: 65 },
    { x: 89, y: 72 },
...
test('`length` should calculate correct length of two point line', () => {
  const shape = [
...
test('`length` should calculate correct length of line with mid-shape moveTo', () => {
  const shape = [
    { x: 0, y: 0, moveTo: true },
    { x: 100, y: 0 },
...
test('`length` should calculate correct length of circle', () => {
  const shape = [
...
test('`length` should calculate correct length of ellipse', () => {
  const shape = [
...
test('`length` should calculate correct length of abstract curved shape', () => {
  const shape = [
